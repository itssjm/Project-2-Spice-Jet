...
public class CommonRunner extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException, AWTException, IOException {
		...
		// signupFirstName.sendKeys("Moses");
		passInputValue(sip.getSignupFirstName(), "Moses");

		// WebElement signupLastName =
		// driver.findElement(By.xpath("//input[@id='last_name']"));
		// signupLastName.sendKeys("SJ");
		passInputValue(sip.getSignupLastName(), "SJ");
		...
		selectByVisibleText(sip.getSelectYear(), "1992");
		...
		passInputValue(sip.getSignupPhoneNumber(), "9876543210");
		...
		passInputValue(sip.getSignupEmailId(), "moses94@gmail.com");
		...
		passInputValue(lp.getLoginPageEmail(), "moses94@gmail.com");
		...
		explicitlyWaitClick(2, fob.getOneWayTripDepartureDatePicker());
		 WebElement oneWayTripDepartureDatePicker = driver.findElement(By.xpath("(//div[@class='css-76zvg2 r-homxoj r-ubezarr-16dba41'][normalize-space()='29'])[1]"));
